...
model = "models/127m_mixed_shelves.pt"
model = YOLO(model)
...
#                                 distance = calculate_distance(centroid, img_center)
#                                 distances.append(distance)
#                             nearest_index = np.argmin(distances)
#                             nearest_points = keypoints[nearest_index]
#                             list1 = [crop_image(nearest_points, img)]
#                     else:
#                         list1 = 'NONE'
